    ...
    <div class="section">
        <div class="container">
            <div class="row">
                ...
                <div class="col s5">
                    <h5><a class="waves-effect waves-light btn right" v-link="{ name: 'bill-pay.create'}"><i
            ...
            <div class="row">
                <table class="bordered highlight responsive-table">
                    ...
                    <tr v-for="(index,o) in bills  | orderBy 'date_due'">
                        ...
                        <td>
                            <a href="#" v-link="{name : 'bill-pay.update', params: {id: o.id}}"><i
                                    class="material-icons teal-text" title="Editar">edit</i></a>
                            <a href="#" @click.prevent="deleteBill(o)"><i class="material-icons red-text lighten-5"
