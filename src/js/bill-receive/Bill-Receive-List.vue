<template>
    <div class="section">
        <div class="container">
            <div class="row">
                ...
                <div class="col s5">
                    <h5><a class="waves-effect waves-light btn right" v-link="{ name: 'bill-receive.create'}"><i
                            class="material-icons left">add</i>Adicionar</a></h5>
                </div>
            </div>
            <div class="row">
                <table class="bordered highlight responsive-table z-depth-3">
                    ...
                    <tr v-for="(index,o) in bills | orderBy 'date_due'">
                        <td>{{index + 1}}</td>
                        <td>{{o.date_due | dateFormat
                        'pt-BR'}}
                        </td>
                        <td>{{o.name | upper}}</td>
                        <td class="right-align">{{o.value | numberFormat
                        'pt-br'
                        'BRL'}}
                        </td>
                        ...
                        <td class="center-align">
                            <a href="#" v-link="{name : 'bill-receive.update', params: {id: o.id}}"><i
                                    class="material-icons teal-text" title="Editar">edit</i></a>
                            <a href="#" @click.prevent="openModalDelete(o)"><i class="material-icons red-text lighten-5"
                                                                               title="Excluir">delete</i></a>
    ...
    <modal :modal="modal">
        ...
        <div slot="footer">
            <button class="btn btn-flat waves-effect green lighten-2 modal-close modal-action" @click="deleteBill()">
                OK
            </button>
